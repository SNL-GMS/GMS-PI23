...
extern "C"
{
    ...
    void cFilterApply(double *data, int num_data, int index_offset, int index_inc, int taper, int zero_phase, double *sos_numerator, double *sos_denominator, int num_sos);
}
