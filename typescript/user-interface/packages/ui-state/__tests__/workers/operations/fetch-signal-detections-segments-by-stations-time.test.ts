...
import { PD01Channel, signalDetectionsData } from '@gms/common-model/__tests__/__data__';
...
import { uiChannelSegmentDescriptor, uiChannelSegmentRecord } from '../../__data__';
...
const dataSegmentData = (uiChannelSegmentRecord as any)[PD01Channel.name][
  WaveformTypes.UNFILTERED
][0].channelSegment.dataSegments[0].data as WeavessTypes.DataBySampleRate;

const waveform: ChannelSegmentTypes.ChannelSegment<WaveformTypes.Waveform> = {
  units: CommonTypes.Units.NANOMETERS,
  id: uiChannelSegmentDescriptor,
