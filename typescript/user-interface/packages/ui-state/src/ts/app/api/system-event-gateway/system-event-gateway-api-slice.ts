...
export const systemEventGatewayApiSlice = createApi({
  ...
  endpoints(build) {
    return {
      ...
      publishDerivedChannel: build.mutation<void, ChannelTypes.Channel>({
...
export const { usePublishDerivedChannelMutation } = systemEventGatewayApiSlice;
export type PublishDerivedChannelMutation = ReturnType<
  typeof systemEventGatewayApiSlice.usePublishDerivedChannelMutation
>;
