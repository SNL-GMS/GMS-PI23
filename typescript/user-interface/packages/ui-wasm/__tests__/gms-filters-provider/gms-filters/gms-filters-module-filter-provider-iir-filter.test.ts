...
describe('FilterProvider::cFilterApply', () => {
  ...
  test('FilterProvider::cFilterApply test', async () => {
    ...
    try {
      ...
      cFilterApply(inputPtr, NUM_SAMPLES, 0, 1, 0, 0, sosNumeratorPtr, sosDenominatorPtr, 3);
  ...
  test('FilterProvider::cFilterApply simple performance test', async () => {
    const gmsFiltersModule: GmsFiltersModule = await gmsFilters();
    expect(gmsFiltersModule).toBeDefined();
    ...
    try {
      ...
      cFilterApply(inputPtr, sampleSize, 0, 1, 0, 0, sosNumeratorPtr, sosDenominatorPtr, 3);
