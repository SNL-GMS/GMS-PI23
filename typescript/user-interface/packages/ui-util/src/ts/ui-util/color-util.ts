...
export const hslToHex = (color: HSL): ColorTypes.Hex => {
  ...
  let rStr = Math.round((rgbmValues[0] + rgbmValues[3]) * 255).toString(16);
  let gStr = Math.round((rgbmValues[1] + rgbmValues[3]) * 255).toString(16);
  let bStr = Math.round((rgbmValues[2] + rgbmValues[3]) * 255).toString(16);
