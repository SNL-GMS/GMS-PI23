...
import { useIanMapTooltipHandler } from './ian-map-tooltip-handler';
import {
  clearEventTooltip,
  clearHoverTooltip,
...
export const IANMapPanelComponent: React.FunctionComponent<IANMapPanelProps> = (
  ...
  const ianMapTooltipHandler = useIanMapTooltipHandler(mapContextMenusCb);
  ...
  return (
    <div className="ian-map-wrapper">
      <MapContextMenus getOpenCallback={setMapContextMenusCb} />
      <Button
        type="button"
