...
import type { History } from '@gms/common-model/lib/cache/types';
...
type IntermediateHistoryEntryProps = HistoryEntryComponentData & History;
...
export interface MultipleHistoryEntryProps extends History {
  description: string;
