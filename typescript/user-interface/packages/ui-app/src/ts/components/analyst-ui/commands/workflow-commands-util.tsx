 ...
 */
export function getLatestInterval<T extends { startTime: number; endTime: number }>(
  intervals: T[]
) {
  return intervals.reduce((latestInterval, intervalToCheck) => {
    if (!latestInterval || intervalToCheck.startTime > latestInterval.startTime) {
 ...
 */
export function getEarliestInterval<T extends { startTime: number; endTime: number }>(
  intervals: T[]
) {
  return intervals.reduce((earliestInterval, intervalToCheck) => {
    if (!earliestInterval || intervalToCheck.startTime < earliestInterval.startTime) {
      return intervalToCheck;
    }
