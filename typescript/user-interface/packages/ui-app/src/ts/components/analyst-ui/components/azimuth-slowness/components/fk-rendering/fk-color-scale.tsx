...
export class FkColorScale extends React.Component<FkColorScaleProps, FkColorScaleState> {
  ...
  private createXAxis() {
    ...
    const x =
      this.props.fkUnits === FkUnits.FSTAT
        ? d3
            ...
            .range([
              FkColorScale.padding,
              this.xAxisContainerRef.clientWidth - FkColorScale.padding
            ])
        : d3
            .scaleLog()
            .domain([this.props.minSlow, this.props.maxSlow])
    ...
    const tickSize = 7;
    const rangeOfScaleInRealPx =
      this.xAxisContainerRef.clientWidth - FkColorScale.padding - FkColorScale.padding;
