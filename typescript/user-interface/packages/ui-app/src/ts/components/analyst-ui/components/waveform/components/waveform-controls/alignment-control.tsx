...
const useAlignmentDropdown = (
  ...
  const { excludedSdPhases } = analystUiConfig.systemConfig;
  const defaultSdPhasesList = analystUiConfig.systemConfig.defaultSdPhases.filter(
    phaseType => !excludedSdPhases.includes(phaseType)
  );
  const prioritySdPhasesList = analystUiConfig.systemConfig.prioritySdPhases.filter(
    phaseType => !excludedSdPhases.includes(phaseType)
  );
