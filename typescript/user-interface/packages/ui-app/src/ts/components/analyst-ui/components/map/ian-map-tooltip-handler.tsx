...
export const useIanMapTooltipHandler = (mapContextMenusCb: MapContextMenusCallbacks) =>
  React.useCallback(
    function IanMapTooltipHandler({ viewer }: MapHandlerProps) {
      if (viewer) {
        ...
        return (
          <ScreenSpaceEventHandler key="IMTHandlers">
            ...
            />
            <ScreenSpaceEvent
              action={position => ianMapTooltipHandleAltClick(position, viewer, mapContextMenusCb)}
