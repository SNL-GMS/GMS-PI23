...
/**
 * Displays the Map Signal Detection Details Context Menu.
 *
 * @params props @see {@link ImperativeContextMenuGetOpenCallbackFunc}
 */
export const MapSignalDetectionDetailsContextMenu = React.memo(
  function MapSignalDetectionDetailsContextMenu(props: {
    getOpenCallback: ImperativeContextMenuGetOpenCallbackFunc<MapSignalDetectionDetailsProps>;
  }): JSX.Element {
    const { getOpenCallback } = props;

    const content = React.useCallback(
      // eslint-disable-next-line react/jsx-props-no-spreading
      (p: MapSignalDetectionDetailsProps) => <MapSignalDetectionDetails {...p} />,
      []
    );

    return (
      <ImperativeContextMenu<MapSignalDetectionDetailsProps>
        content={content}
