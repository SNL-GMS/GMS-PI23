...
import type { EventTypes, FkTypes, SignalDetectionTypes, StationTypes } from '@gms/common-model';
...
export class FkDisplay extends React.Component<FkDisplayProps, FkDisplayState> {
  ...
  public render(): JSX.Element {
    ...
    const selectedFk = signalDetection ? getFkDummyData(this.props.signalDetection) : undefined;
  ...
  private readonly onLeadTimeChanged = (newLeadSeconds: number) => {
    ...
    this.props.onNewFkParams(newParams, priorConfig);
  };
  ...
  private readonly onFkConfigurationChange = (
    ...
    const previousFk = getFkDummyData(this.props.signalDetection);
