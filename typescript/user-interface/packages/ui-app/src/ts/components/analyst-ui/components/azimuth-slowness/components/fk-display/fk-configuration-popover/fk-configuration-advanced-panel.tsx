    ...
    <div className="continous-fk-popover-panel">
      ...
      >
        <div className="popover-header">
          ...
          <div className="popover-header__widget">
            <input
              min={systemConfig.continuousFkConfiguration.minMediumVelocity}
              max={systemConfig.continuousFkConfiguration.maxMediumVelocity}
      ...
      <div className="popover-section">
        ...
        >
          <div className="popover-header">
            ...
            <div className="popover-header__widget">
              <input
                min={systemConfig.continuousFkConfiguration.minMaximumSlowness}
                max={systemConfig.continuousFkConfiguration.maxMaximumSlowness}
                // eslint-disable-next-line @typescript-eslint/no-magic-numbers
                step={0.1}
          ...
          <div className="popover-header">
            ...
            <div className="popover-header__widget">
              <input
                min={systemConfig.continuousFkConfiguration.minNumberOfPoints}
                max={systemConfig.continuousFkConfiguration.maxNumberOfPoints}
                step={1}
                style={{
                  width: '54px',
                  margin: '3px'
