...
import {
  ...
  useSetOpenInterval
} from '~analyst-ui/components/workflow/workflow-util';
    ...
    (): Command[] =>
      [
        ...
        workflowIntervalAL1 && {
          ...
          action: async () => {
            toast.info(`Opening interval at ${toOSDTime(workflowIntervalAL1.startTime)}`);
        ...
        workflowIntervalAL2 && {
          ...
          action: async () => {
            toast.info(`Opening interval at ${toOSDTime(workflowIntervalAL2.startTime)}`);
