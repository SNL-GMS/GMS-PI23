...
/**
 * Determine hotkey to return based on the user OS.
 *
 * @param hotkeys Comma+space separated string of available hotkeys.
 * @returns Proper hotkey for the OS.
 */
export const getHotkeysForOS = (hotkeys = '') => {
  const os = getOS();
  return hotkeys
    .split(', ')
