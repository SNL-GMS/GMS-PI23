...
import { qcSegment, signalDetectionsData } from '@gms/common-model/__tests__/__data__';
...
describe('weavess display', () => {
  ...
  weavessDisplayComponent.qcContextMenuCb = {
  ...
  test('onChannelClick', () => {
    ...
    // eslint-disable-next-line @typescript-eslint/unbound-method
    expect(mockCreateSignalDetection).toHaveBeenCalledTimes(2);
