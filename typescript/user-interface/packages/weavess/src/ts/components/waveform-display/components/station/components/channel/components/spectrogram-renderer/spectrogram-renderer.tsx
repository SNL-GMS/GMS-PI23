...
> {
  ...
  private readonly updateCameraBounds = (prevProps: SpectrogramRendererProps) => {
    const scale = d3
      .scaleLinear()
      .domain([prevProps.displayInterval.startTimeSecs, prevProps.displayInterval.endTimeSecs])
  ...
  private readonly createColorScale: any = (min: number, max: number) =>
    d3
      .scaleSequential((t): string => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-magic-numbers, yoda, newline-per-chained-call
