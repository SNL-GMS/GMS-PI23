...
> {
  ...
  private readonly onSelectionWindowClick = (event: React.MouseEvent<HTMLDivElement>) => {
    if (event.button === 2 || event.shiftKey || event.ctrlKey || event.metaKey) return;
    ...
    borderMarkers.push(
      this.props.selectionWindow.isMoveable ? (
        <MoveableMarker
          ...
          key={this.props.selectionWindow.startMarker.id}
    ...
    borderMarkers.push(
      this.props.selectionWindow.isMoveable ? (
        <MoveableMarker
          ...
          key={this.props.selectionWindow.endMarker.id}
