...
> {
  ...
  public getMessageFromDescription(): string {
    return typeof this.props.description === 'string'
      ? this.props.description
      : this.props.description.message;
  }

  public getTooltipMessageFromDescription(): string {
    return typeof this.props.description === 'string'
      ? null
      : this.props.description.tooltipMessage;
  }

  public getIsErrorFromDescription(): boolean {
    return typeof this.props.description === 'string' ? false : this.props.description.isError;
  }
          ...
          {this.props.description ? (
            ...
            >
              <ChannelDescriptionLabel
                isError={this.getIsErrorFromDescription()}
                message={this.getMessageFromDescription()}
                tooltipMessage={this.getTooltipMessageFromDescription()}
              />
            </div>
          ) : undefined}
        </div>
