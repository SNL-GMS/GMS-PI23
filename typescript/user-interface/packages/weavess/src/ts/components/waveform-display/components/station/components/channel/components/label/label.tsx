...
export class Label extends React.PureComponent<WeavessTypes.LabelProps, LabelState> {
  ...
  public render(): JSX.Element {
    ...
    const expandText = this.props.expanded ? '-' : '+';
    /* render expansion button if there are additional channels */
    const expandElem = this.props.isExpandable ? (
    ...
    const labelWithoutExpansion = <div className="label-container-left-child" />;
    const contextMenuLabel = this.props.isDefaultChannel ? (
      /* render parent label with expansion button */
      <div className="label-container-left-parent">{expandElem}</div>
    ) : (
