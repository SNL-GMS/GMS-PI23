...
public class ChannelSegmentTestFixtures {
  ...
  public static ChannelSegment<Waveform> createChannelSegmentChannelSegmentDescriptor(
    ...
    return ChannelSegment.from(channelSegmentDescriptor, units, waveforms, List.of());//TODO: Future work- add calls to retrieve processing masks
  }
  ...
  public static ChannelSegment<Waveform> createChannelSegment(Channel channel,
    ...
    return ChannelSegment.from(channel, units, waveforms, creationTime, List.of());//TODO: Future work- add calls to retrieve processing masks
  }
