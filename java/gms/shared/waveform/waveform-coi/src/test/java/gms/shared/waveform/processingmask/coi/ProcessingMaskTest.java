...
class ProcessingMaskTest {
  ...
  void testSerialization() {
    ...
    var qcSegmentVersionTwo = QcSegmentVersion.instanceBuilder()
      .setId(qcSegmentVersionId)
      .setData(QcSegmentVersion.Data.instanceBuilder()
        .setStageId(WorkflowDefinitionId.from("My Workflow"))
        .setChannels(List.of(channel))
    ...
    var idArray
      ...
      + ProcessingOperation.AMPLITUDE_MEASUREMENT_BEAM + channel.getName();
    var uuid = UUID.nameUUIDFromBytes(idArray.getBytes());

    var pmFull = ProcessingMask.instanceBuilder()
      .setId(uuid)
  ...
  void testDataEmptyPreconditions() {
    ...
    //times are missing
    var data = ProcessingMask.Data.instanceBuilder()
    ...
    //empty version list
    var data1 = ProcessingMask.Data.instanceBuilder()
    ...
    var data2 = ProcessingMask.Data.instanceBuilder()
      .setEffectiveAt(timeInstant)
      .setStartTime(timeInstant)
