...
class QcSegmentTest {
  ...
  void testQcSegmentVersionOrdering() {
    ...
    var qcSegmentVersionId_1 = QcSegmentVersionId.instanceBuilder()
      .setEffectiveAt(Instant.MIN)
      .setParentQcSegmentId(uuid)
      .build();

    var qcSegmentVersionId_2 = QcSegmentVersionId.instanceBuilder()
    ...
    var data = QcSegment.Data.instanceBuilder()
      .setChannel(channel)
      .setVersionHistory(new TreeSet<>(versionSet))
      .build();

    var qcSegment = QcSegment.instanceBuilder()
      .setId(uuid)
      .setData(data)
      .build();
  ...
  void testSerialization() {
    ...
    var channel = ChannelSegmentTestFixtures.getTestChannel("TEST.TEST1.BHZ");
    var channelSegment = ChannelSegmentTestFixtures.createChannelSegment(channel, List.of(WaveformTestFixtures.WAVEFORM_1));
    ...
    var data = QcSegment.Data.instanceBuilder()
      .setChannel(channel)
      .setVersionHistory(new TreeSet<>(Set.of(
    ...
    var fullQcSegment = QcSegment.instanceBuilder()
      .setId(uuid)
      .setData(data)
      .build();
  ...
  void testFacetedVersionSerialization() {
    ...
    var qcSegmentVersionEntityReference = QcSegmentVersion.createEntityReference(qcSegmentVersionId);
  ...
  void testPreviousHistoryFaceting() {
    ...
    var qcSegmentVersion_1 = QcSegmentVersion.instanceBuilder()
    ...
    var qcSegmentVersion_2 = QcSegmentVersion.instanceBuilder()
    ...
    Assertions.assertTrue(reducedQcSegment.getData().get()
      .getVersionHistory().last().getData().isPresent());
    Assertions.assertTrue(reducedQcSegment.getData().get()
      .getVersionHistory().first().getData().isEmpty());
