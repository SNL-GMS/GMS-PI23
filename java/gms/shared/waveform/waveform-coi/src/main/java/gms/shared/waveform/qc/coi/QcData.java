...
public class QcData {
  ...
  public String toString() {
    return "QcData{qcmaskid=" + qcmaskid + ", sta=" + sta + ", chan=" + chan
      + ", startTime=" + startTime + ", endTime=" + endTime + ", sampRate=" + sampRate
      + ", nseg=" + nseg + ", qcdefid=" + qcdefid + ", lddate=" + lddate
      + ", startSample=" + startSample + ", endSample="
      + endSample + ", maskType=" + maskType + '}';
  }
}
