...
public class ChannelSegmentConvertImpl implements ChannelSegmentConverter {
  ...
  /**
   * Converts a Channel a list of WfdiscDao and File pairs into a
   * {@link ChannelSegment<Waveform>}
   *
   * @param channel The channel corresponding to the wfdiscDaos
   * @param wfdiscDaos a list of WfdiscDaos
   *
   * @return A ChannelSegment representing the provided channel, wfdisDaos, and
   * .w files
   */
  public ChannelSegment<Waveform> convert(Channel channel, List<WfdiscDao> wfdiscDaos, Instant startTime,
    ...
    return ChannelSegment.from(channel, units, waveforms, timeRange.lowerEndpoint(), List.of());//TODO: Future work- add calls to retrieve processing masks
  }
   ...
   * @param wfdiscDaos a list of WfdiscDaos
   *
   * @return A ChannelSegment representing the provided
   * channelSegmentDescriptor, wfdisDaos, and .w files
   */
  public ChannelSegment<Waveform> convert(ChannelSegmentDescriptor channelSegmentDescriptor,
    ...
    return ChannelSegment.from(channelSegmentDescriptor, units, waveformList, List.of());//TODO: Future work- add calls to retrieve processing masks
  }
  ...
  /**
   * readWaveforms from a file, producing multiple waveforms if the file
   * contains more data than a single double array can hold
   *
