...
public abstract class FilterDefinitionByUsageForChannelSegmentsRequest {
  ...
  public interface Builder {
    ...
    FilterDefinitionByUsageForChannelSegmentsRequest.Builder setChannelSegments(ImmutableList<ChannelSegment<Waveform>> channelSegments);

    default FilterDefinitionByUsageForChannelSegmentsRequest.Builder setChannelSegments(Collection<ChannelSegment<Waveform>> channelSegments) {
      return setChannelSegments(ImmutableList.copyOf(channelSegments));
    }

    FilterDefinitionByUsageForChannelSegmentsRequest.Builder setEventHypothesis(Optional<EventHypothesis> eventHypothesis);

    default FilterDefinitionByUsageForChannelSegmentsRequest.Builder setEventHypothesis(EventHypothesis eventHypothesis) {
    ...
    default FilterDefinitionByUsageForChannelSegmentsRequest build() {
      ...
      Validate.notEmpty(filterDefinitionByUsageForChannelSegmentsRequest.getChannelSegments(),
