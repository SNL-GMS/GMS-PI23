...
@JsonDeserialize(builder = AutoValue_FilterDefinitionByUsageForSignalDetectionHypothesesRequest.Builder.class)
...
public abstract class FilterDefinitionByUsageForSignalDetectionHypothesesRequest {
  ...
  public interface Builder {
    ...
    FilterDefinitionByUsageForSignalDetectionHypothesesRequest.Builder setSignalDetectionsHypotheses(ImmutableList<SignalDetectionHypothesis> signalDetectionHypotheses);

    default FilterDefinitionByUsageForSignalDetectionHypothesesRequest.Builder setSignalDetectionsHypotheses(Collection<SignalDetectionHypothesis> signalDetectionHypotheses) {
      return setSignalDetectionsHypotheses(ImmutableList.copyOf(signalDetectionHypotheses));
    }

    FilterDefinitionByUsageForSignalDetectionHypothesesRequest.Builder setEventHypothesis(Optional<EventHypothesis> eventHypothesis);

    default FilterDefinitionByUsageForSignalDetectionHypothesesRequest.Builder setEventHypothesis(EventHypothesis eventHypothesis) {
    ...
    default FilterDefinitionByUsageForSignalDetectionHypothesesRequest build() {
      ...
      Validate.notEmpty(filterDefinitionByUsuageForSignalDetectionHypothesesRequest.getSignalDetectionsHypotheses(),
