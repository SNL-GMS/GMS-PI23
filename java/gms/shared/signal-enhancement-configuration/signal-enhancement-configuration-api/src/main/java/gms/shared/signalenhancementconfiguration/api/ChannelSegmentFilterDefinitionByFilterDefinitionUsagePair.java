...
/**
 * Pair object of ChannelSegmentDescriptor {@link ChannelSegmentDescriptor}
...
@JsonDeserialize(builder = AutoValue_ChannelSegmentFilterDefinitionByFilterDefinitionUsagePair.Builder.class)
public abstract class ChannelSegmentFilterDefinitionByFilterDefinitionUsagePair {
  ...
  public static ChannelSegmentFilterDefinitionByFilterDefinitionUsagePair create(
    ...
    return builder().setChannelSegment(channelSegment)
