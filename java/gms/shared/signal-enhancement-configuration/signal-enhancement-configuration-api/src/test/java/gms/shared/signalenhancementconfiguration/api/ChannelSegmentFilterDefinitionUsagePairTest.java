...
class ChannelSegmentFilterDefinitionUsagePairTest {
  ...
  void serialization() {
    Channel channel = Channel.builder()
      ...
      .build();
    ChannelSegment cs = ChannelSegment.builder()
                  .setId(ChannelSegmentDescriptor.from(channel, Instant.EPOCH.plusSeconds(10), Instant.EPOCH, Instant.EPOCH))
                  .build();
    ChannelSegmentFilterDefinitionByFilterDefinitionUsagePair channelSegmentDescriptorFilterDefinitionUsagePair
      = ChannelSegmentFilterDefinitionByFilterDefinitionUsagePair.
        create(cs, getFilterDefinitionByFilterDefinitionUsage());

    TestUtilities.assertSerializes(channelSegmentDescriptorFilterDefinitionUsagePair,
