...
class SignalDetectionHypothesisFilterDefinitionByFilterDefinitionUsagePairTest {
  ...
  @Test
  void serialization() {
    SignalDetectionHypothesisFilterDefinitionByFilterDefinitionUsagePair signalDetectionHypothesisFilterDefinitionByFilterDefinitionUsagePair
    ...
    TestUtilities.assertSerializes(signalDetectionHypothesisFilterDefinitionByFilterDefinitionUsagePair,
