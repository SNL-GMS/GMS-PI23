...
class FilterDefinitionUsageForChannelSegmentsRequestTest {
      @Test
  void serialization() {
    EventHypothesis eventHypothesis = EventFixture.generateDummyEventHypothesisForFilterTest(10, 10);
    Collection<ChannelSegment<Waveform>> channelSegments = List.of(SignalDetectionFixture.ARRIVAL_CHANNEL_SEGMENT);
    FilterDefinitionByUsageForChannelSegmentsRequest filterDefinitionByUsuageForChannelSegmentsRequest = 
    ...
    TestUtilities.assertSerializes(filterDefinitionByUsuageForChannelSegmentsRequest,
