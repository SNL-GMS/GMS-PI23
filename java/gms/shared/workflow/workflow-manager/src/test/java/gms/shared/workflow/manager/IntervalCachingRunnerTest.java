...
import gms.shared.workflow.manager.IntervalCachingRunner.IntervalCacheUpdateRunnable;
...
class IntervalCachingRunnerTest {
  ...
  @Mock
  IntervalCacheUpdater mockUpdater;

  @Mock
  SystemEventPublisher mockPublisher;

  @Mock
  WorkflowManagerConfigurationUtility mockConfigUtil;

  @Mock
  TaskScheduler mockScheduler;

  @Captor
  ArgumentCaptor<IntervalCacheUpdateRunnable> runnableCaptor;

  private gms.shared.workflow.manager.IntervalCachingRunner intervalCachingRunner;

  @BeforeEach
  void setup() {
    this.intervalCachingRunner = new IntervalCachingRunner(mockUpdater, mockPublisher, mockConfigUtil, mockScheduler);
  }
  ...
  void testRun() throws Exception {
    ...
    Set<StageInterval> intervals = Set.of(IntervalFixtures.notStartedInteractiveAnalysisStageInterval);
