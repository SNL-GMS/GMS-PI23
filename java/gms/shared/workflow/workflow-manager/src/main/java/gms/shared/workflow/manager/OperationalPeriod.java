...
public abstract class OperationalPeriod {
  ...
  public static OperationalPeriod now(Duration operationalStartPeriod, Duration operationalEndPeriod) {
    return from(Instant.now(), operationalStartPeriod, operationalEndPeriod);
  }

  public static OperationalPeriod from(Instant currentTime, Duration operationalStartPeriod, Duration operationalEndPeriod) {
