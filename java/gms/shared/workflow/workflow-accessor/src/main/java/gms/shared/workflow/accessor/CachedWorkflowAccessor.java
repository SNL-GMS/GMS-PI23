...
/**
 * Accessor implementation of the Manager/Accessor/Repository pattern for the Workflow domain. Provides workflow-related
 * COI access through caches of the {@link Workflow} and all {@link gms.shared.workflow.coi.Interval}s within the
 * operational time period.
 */
@Component
public class CachedWorkflowAccessor implements WorkflowAccessorInterface {
   ...
   */
  @Autowired
  public CachedWorkflowAccessor(Workflow workflow,
