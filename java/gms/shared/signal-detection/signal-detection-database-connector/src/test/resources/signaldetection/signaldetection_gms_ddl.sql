...
CREATE TABLE IF NOT EXISTS GMS_GLOBAL.AMPLITUDE
(
AMPID NUMBER(18,0),
ARID NUMBER(18,0),
PARID NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS GMS_GLOBAL.ARRIVAL_DYN_PARS_INT
(	
ARID NUMBER(18,0) NOT NULL,
GROUP_NAME VARCHAR2(48) NOT NULL,
PARAM_NAME VARCHAR2(48) NOT NULL,
I_VALUE NUMBER(18,0) NOT NULL,
...
CONSTRAINT ARRIVAL_DYN_PARS_INT_PK 
  PRIMARY KEY (ARID, GROUP_NAME, PARAM_NAME)
);
