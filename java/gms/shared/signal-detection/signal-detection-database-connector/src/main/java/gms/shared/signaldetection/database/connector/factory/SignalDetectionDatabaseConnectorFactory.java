...
/**
 * Signal detection database connector factory for creating signal detection
 * connector instances
 */
public class SignalDetectionDatabaseConnectorFactory {
   ...
   *
   * @param entityManagerFactory the entity manager that supplies the
   * connections to be used by the db connectors
   *
  ...
  public static SignalDetectionDatabaseConnectorFactory create(
    ...
    Validate.notNull(entityManagerFactory, "EntityManagerFactory must be provided.");
