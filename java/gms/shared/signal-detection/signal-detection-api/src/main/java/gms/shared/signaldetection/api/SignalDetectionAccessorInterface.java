...
public interface SignalDetectionAccessorInterface extends SignalDetectionRepositoryInterface {
  ...
  Mono<FilterDefinitionByUsageBySignalDetectionHypothesis> findFilterDefinitionsForSignalDetections(List<SignalDetection> signalDetections, WorkflowDefinitionId stageId);
}
