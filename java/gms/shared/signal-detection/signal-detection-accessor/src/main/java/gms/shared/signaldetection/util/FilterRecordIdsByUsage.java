...
/**
 * Interim container object to maintain the relation between a mapping of filter 
 * IDs by their {@link FilterDefinitionUsage} and their associated {@link SignalDetectionHypothesis}
 */
@AutoValue
public abstract class FilterRecordIdsByUsage {
  ...
  public static FilterRecordIdsByUsage create(Map<FilterDefinitionUsage, Long> idsByUsage, SignalDetectionHypothesis hypothesis) {
