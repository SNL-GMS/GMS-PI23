...
class EntityCachingStationDefinitionAccessorTest {
  ...
  void findStationGroupsByNameAndTimeHitTest() {
    ...
    verify(cache, times(1)).retrieveVersionsByEntityIdAndTime(entityIdCaptor.capture(), startTimeCaptor.capture());
  ...
  void findStationsByNameAndTimeRangeMissTest() {
    ...
    Station testStation1 = Station.createVersionReference(STATION.getName(), STATION.getEffectiveAt().get());
    testStation1 = testStation1.toBuilder()
      .setData(
        STATION.getData().orElseThrow().toBuilder()
          .setAllRawChannels(entityReferenceChannels)
          .setChannelGroups(facetedChannelGroup).build()).build();

    Station testStation2 = Station.createVersionReference(STATION_2.getName(), STATION_2.getEffectiveAt().get());
    testStation2 = testStation2.toBuilder()
      .setData(
  ...
  void determineStationChangeTimesTest() {
    ...
    when(delegate.findChannelsByNameAndTimeRange(List.of(CHANNEL.getName(), CHANNEL_TWO.getName()),
      changeRequest.getStartTime(), changeRequest.getEndTime()))
    ...
    when(delegate.findResponsesByIdAndTimeRange(List.of(UtilsTestFixtures.getResponse(CHANNEL.getName()).getId(), UtilsTestFixtures.getResponse(CHANNEL_TWO.getName()).getId()),
      changeRequest.getStartTime(), changeRequest.getEndTime()))
      .thenReturn(List.of(UtilsTestFixtures.getResponse(CHANNEL.getName()).toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(600)).build(), UtilsTestFixtures.getResponse(CHANNEL_TWO.getName()).toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(500)).build()));
  ...
  void determineStationChangeTimesOutOfRangeTest() {
    ...
    when(delegate.findChannelsByNameAndTimeRange(List.of(CHANNEL.getName(), CHANNEL_TWO.getName()),
      changeRequest.getStartTime(), changeRequest.getEndTime()))
      .thenReturn(List.of(CHANNEL.toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(300)).build(), CHANNEL_TWO.toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(400)).build()));
    ...
    when(delegate.findResponsesByIdAndTimeRange(List.of(UtilsTestFixtures.getResponse(CHANNEL.getName()).getId(), UtilsTestFixtures.getResponse(CHANNEL_TWO.getName()).getId()),
      ...
      .thenReturn(List.of(UtilsTestFixtures.getResponse(CHANNEL.getName()).toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(600)).build(),
        UtilsTestFixtures.getResponse(CHANNEL_TWO.getName()).toBuilder().setEffectiveAt(Instant.EPOCH.plusSeconds(500)).build()));
...
//
  ...
  void findChannelsByNameAndTimeFacet_populated_HitTest() {
    ...
    // verify cache was called and response is correct
    verify(cache, times(1)).retrieveVersionsByEntityIdAndTime(entityIdCaptor.capture(),
      startTimeCaptor.capture());
...
//   --------------------------- */
  ...
  void testCache() {
    ...
    when(delegate.findChannelsByNameAndTimeRange(List.of(CHANNEL.getName(), CHANNEL_TWO.getName()), START_TIME, END_TIME))
      .thenReturn(List.of(CHANNEL, CHANNEL_TWO));
    when(delegate.findResponsesByIdAndTimeRange(List.of(CHANNEL.getResponse().map(Response::getId).orElseThrow(), CHANNEL_TWO.getResponse().map(Response::getId).orElseThrow()),
      START_TIME,
      END_TIME))
      .thenReturn(List.of(CHANNEL.getResponse().orElseThrow(), CHANNEL_TWO.getResponse().orElseThrow()));
    ...
    verify(delegate, times(1))
      .findChannelsByNameAndTimeRange(List.of(CHANNEL.getName(), CHANNEL_TWO.getName()), START_TIME, END_TIME);
    verify(delegate, times(1))
      .storeChannels(List.of(CHANNEL, CHANNEL_TWO));
    verify(delegate, times(2)).storeResponses(List.of(CHANNEL.getResponse().orElseThrow(),
      CHANNEL_TWO.getResponse().orElseThrow()));

    verify(delegate, times(1)).findResponsesByIdAndTimeRange(
      List.of(CHANNEL.getResponse().map(Response::getId).orElseThrow(), CHANNEL_TWO.getResponse().map(Response::getId).orElseThrow()),
      START_TIME,
      END_TIME);
