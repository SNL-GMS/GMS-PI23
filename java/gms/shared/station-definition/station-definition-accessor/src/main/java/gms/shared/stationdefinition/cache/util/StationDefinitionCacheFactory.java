...
public class StationDefinitionCacheFactory {
  ...
  public static final CacheInfo CHANNEL_RESPONSE_CACHE = new CacheInfo("channel-response-cache",
    CacheMode.REPLICATED, CacheAtomicityMode.ATOMIC, true, Optional.empty());
  public static final CacheInfo VERSION_EFFECTIVE_TIME_DERIVED_CACHE = new CacheInfo("version-effective-time-derived-cache",
    CacheMode.REPLICATED, CacheAtomicityMode.ATOMIC, true, Optional.empty());
  public static final CacheInfo VERSION_ENTITY_TIME_DERIVED_CACHE = new CacheInfo("version-entity-time-derived-cache",
    CacheMode.REPLICATED, CacheAtomicityMode.ATOMIC, true, Optional.empty());
