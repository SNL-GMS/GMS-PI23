...
/**
 * A {@link StationDefinitionAccessorInterface} implementation that allows for
 * RequestCaching. This is intended to be used as member in a chain of command
 * where cache misses passed to the delegate.
 */
@Primary
...
public class RequestCachingStationDefinitionAccessor implements StationDefinitionAccessorInterface {
  ...
  public List<StationGroup> findStationGroupsByNameAndTime(List<String> stationGroupNames, Instant effectiveAt) {
    ...
    Request request;
    if (effectiveAt == null) {
      request = StationGroupsTimeRequest.builder()
    ...
    if (cacheResponse.isEmpty()) {
      List<StationGroup> delegateResponse = delegate.findStationGroupsByNameAndTime(
  ...
  public List<Station> findStationsByNameAndTime(List<String> stationNames, Instant effectiveAt) {
    ...
    Request request;
    if (effectiveAt == null) {
      request = StationsTimeRequest.builder()
    ...
    Collection<Object> cacheResponse = requestCache.retrieve(request);
    if (cacheResponse.isEmpty()) {
      List<Station> delegateResponse = delegate.findStationsByNameAndTime(
  ...
  public List<ChannelGroup> findChannelGroupsByNameAndTime(List<String> channelGroupNames, Instant effectiveAt) {
    ...
    Request request;
    if (effectiveAt == null) {
      request = ChannelGroupsTimeRequest.builder()
    ...
    Collection<Object> cacheResponse = requestCache.retrieve(request);
    if (cacheResponse.isEmpty()) {
      List<ChannelGroup> delegateResponse = delegate.findChannelGroupsByNameAndTime(
  ...
  public List<Channel> findChannelsByNameAndTime(List<String> channelNames, Instant effectiveAt) {
    ...
    Request request;
    if (effectiveAt == null) {
      request = ChannelsTimeRequest.builder()
    ...
    Collection<Object> cacheResponse = requestCache.retrieve(request);
    if (cacheResponse.isEmpty()) {
      List<Channel> delegateResponse = delegate.findChannelsByNameAndTime(
        channelNames, effectiveTime);
      requestCache.put(request, new ArrayList<>(delegateResponse));
      return delegateResponse;
    } else {
      return cacheResponse.stream()
