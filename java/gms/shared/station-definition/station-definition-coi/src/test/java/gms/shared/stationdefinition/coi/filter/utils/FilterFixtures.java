...
public class FilterFixtures {
  ...
  public static final LinearFilterDescription LINEAR_IIR_BUTTERWORTH_DESCRIPTION = LinearFilterDescription.from(
    Optional.of(FILTER1_COMMENTS), true, FilterType.IIR_BUTTERWORTH, Optional.of(0.7), Optional.of(2.0), 
