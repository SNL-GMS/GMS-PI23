...
class QcSegmentCategoryAndTypeTest {
  ...
  void testSerialization() {
    var qcSegmentCategoryAndType = QcSegmentCategoryAndType.create(
  ...
  void testBadTypes() {
    ...
    Assertions.assertThrows(
      IllegalArgumentException.class,
      () -> QcSegmentCategoryAndType.create(QcSegmentCategory.WAVEFORM, QcSegmentType.STATION_PROBLEM)
    );
  }
