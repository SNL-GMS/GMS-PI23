...
public enum PassBandType {
   ...
   * @throws IllegalArgumentException if the provided string does not map to a valid {@link PassBandType}
   */
  public static PassBandType fromString(String value) {
    ...
    throw new IllegalArgumentException(String.format("String value %s does not map to a PassBandType enumeration.", value));
  }
}
