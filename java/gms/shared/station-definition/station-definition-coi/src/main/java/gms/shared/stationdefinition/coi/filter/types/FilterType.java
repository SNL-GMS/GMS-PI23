...
public enum FilterType {
  CASCADE("C"),
  FIR_HAMMING("H"), // Assumption; future support for this type will likely modify its value representation
  IIR_BUTTERWORTH("B");
   ...
   * @throws IllegalArgumentException if the provided string does not map to a valid {@link FilterType}
   */
  public static FilterType fromString(String value) {
    ...
    throw new IllegalArgumentException(String.format("String value %s does not map to a FilterType enumeration.", value));
  }
}
