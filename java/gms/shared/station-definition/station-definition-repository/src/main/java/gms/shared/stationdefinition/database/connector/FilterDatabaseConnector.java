...
public class FilterDatabaseConnector extends DatabaseConnector {
  ...
  public FilterDatabaseConnector(@Qualifier("entityManagerFactory") EntityManagerFactory entityManagerFactory) {
  ...
  public List<FilterDao> findFiltersByIds(Collection<Long> filterIds) {
    ...
    if (filterIds == null || filterIds.isEmpty()) {
      ...
      return runPartitionedQuery(filterIds, 950, partitionedFilterids -> {
        EntityResultListFunction<FilterDao> delegateFunction = entityManager -> {
