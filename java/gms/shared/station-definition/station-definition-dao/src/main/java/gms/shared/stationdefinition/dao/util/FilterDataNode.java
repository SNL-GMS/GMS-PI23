...
/**
 * FilterDataNode represents a "node" on the conceptual "tree" that represents a
 * filter record and its possible cascading filter records. Specifically this
 * class allows the tracking of a {@link FilterDao} and its corresponding
 * {@link FilterGroupDao}s and child {@link FilterDao}s.
 */
@AutoValue
