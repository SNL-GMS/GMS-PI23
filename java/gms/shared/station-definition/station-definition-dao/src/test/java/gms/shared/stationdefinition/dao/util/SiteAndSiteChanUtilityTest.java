...
class SiteAndSiteChanUtilityTest {
  ...
  void testUpdateStartEndAndReturnSiteDaos() {
    ...
    var siteSet = List.of(site1, site2, site3, site4, site5, site6).stream()
    ...
    var sitesAndSurroundings = List.of(siteAndSurrounding1, siteAndSurrounding2,
      siteAndSurrounding3, siteAndSurrounding4, siteAndSurrounding5, siteAndSurrounding6);

    var returned = SiteAndSiteChanUtility.updateStartEndAndReturnSiteDaos(actual, sitesAndSurroundings);
  ...
  void testUpdateStartEndAndReturnSiteChanDaos() {
    ...
    var siteChanSet = List.of(siteChan1, siteChan2, siteChan3, siteChan4, siteChan5, siteChan6, siteChan7).stream()
      .collect(Collectors.toList());
    ...
    var siteChanAndSurroundings = List.of(siteChanAndSurrounding1, siteChanAndSurrounding2,
      siteChanAndSurrounding3, siteChanAndSurrounding4, siteChanAndSurrounding5, siteChanAndSurrounding6,
      siteChanAndSurrounding7);

    var returned = SiteAndSiteChanUtility.updateStartEndAndReturnSiteChanDaos(actual, siteChanAndSurroundings);
    var returnedSet = returned.stream().collect(Collectors.toList());
