...
class ChannelAssemblerTest {
  ...
  void testGetListOfCssDaosPerChannelGroup() {
    ...
    List<Channel> compareChannel = UtilsTestFixtures.getListOfTestChannels();
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(ONDATE, siteDaos, siteChanDaos, sensorDaos, wfdiscDaos, getResponses(compareChannel), startAndEndBooleans);
  ...
  void testResponseAddedAndRemoved() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(ONDATE4, siteDaos, siteChanDaos, sensorDaos, wfdiscDaos, List.of(response), startAndEndBooleans);
  ...
  void testNewVersionDueToResponseRemovedAndThenSampleRateChanged() {
    var sampleRateChanged
      = createSensorDao(STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE4, CssDaoAndCoiParameters.ONDATE5);
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(AssemblerUtils.effectiveAtNoonOffset.apply(ONDATE4), siteDaos, siteChanDaos, sensorDaos, wfdiscDaos, List.of(response), startAndEndBooleans);
  ...
  void testWfdiscEndsBeforeSiteChan() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(ONDATE3, siteDaos, siteChanDaos, sensorDaos, wfdiscDaos, List.of(), startAndEndBooleans);
  ...
  void testGetListOfCssDaosPerChannelGroupMissingSensorDao() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(AssemblerUtils.effectiveAtNoonOffset.apply(ONDATE),
      siteDaos, siteChanDaos, sensorDaos, wfdiscDaos, List.of(), startAndEndBooleans);
  ...
  void testGetListOfCssDaosPerChannelGroupMissingSiteChanDao() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(AssemblerUtils.effectiveAtNoonOffset.apply(ONDATE), siteDaos,
      siteChanDaos, sensorDaos, wfdiscDaos, List.of(), startAndEndBooleans);
  ...
  void testGetListOfCssDaosPerChannelGroupMissingSiteDao() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTime(
      ...
      wfdiscDaos, List.of(), startAndEndBooleans);
  ...
  void testChannelCreatedFromWfdisc() {
    ...
    List<Channel> compareChannel = UtilsTestFixtures.getListOfTestChannels().stream()
      .map(channel -> {
        var data = channel.getData().get().toBuilder()
  ...
  void testWfdiscAddedAfterChannelCreatedAndInstrumentSampleRateChanged() {
    ...
    List<Channel> channels = channelAssembler.buildAllForTimeRange(SITE_DAO_1.getId().getOnDate(), Instant.MAX, siteDaos, siteChanDaos, sensorDaos,
      wfdiscDaos, List.of(response), startAndEndBooleans);
