...
import static gms.shared.stationdefinition.converter.ConverterUtils.AFFILIATIONS_NOT_NULL;
import static gms.shared.stationdefinition.converter.ConverterUtils.EFFECTIVE_TIME_STR;
import static gms.shared.stationdefinition.converter.ConverterUtils.NETWORKS_NOT_NULL;
import static gms.shared.stationdefinition.converter.ConverterUtils.STATIONS_NOT_NULL;
import static gms.shared.stationdefinition.converter.ConverterUtils.STATION_GROUPS_NOT_NULL;
import static gms.shared.stationdefinition.converter.ConverterUtils.TIME_RANGE_STR;
...
public class StationGroupAssembler {
  ...
  public List<StationGroup> buildAllForTime(Instant effectiveAt,
    ...
    Preconditions.checkNotNull(affiliationDaos, AFFILIATIONS_NOT_NULL + EFFECTIVE_TIME_STR, effectiveAt);
  ...
  private List<StationGroup> processStationGroups(
    ...
    return processPossibleVersionTimes(validTimes, netWorksInRange, affiliationsInRange, stationTemporalMap, stationFacetOperator);
  }
