...
import static gms.shared.stationdefinition.converter.ConverterUtils.CHANNELS_NOT_EMPTY;
import static gms.shared.stationdefinition.converter.ConverterUtils.CHANNEL_GROUPS_NOT_EMPTY;
import static gms.shared.stationdefinition.converter.ConverterUtils.SITES_NOT_EMPTY;
...
import static gms.shared.stationdefinition.converter.ConverterUtils.VERSION_END_STR;
import static gms.shared.stationdefinition.converter.ConverterUtils.VERSION_START_STR;
...
public class DaoStationConverter implements StationConverter {
  ...
  public Station convert(Instant versionStartTime, Instant versionEndTime,
    ...
    Preconditions.checkNotNull(siteDaos, SITES_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkNotNull(siteChanDaos, SITE_CHANS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkNotNull(channelGroups, CHANNEL_GROUPS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkNotNull(channels, CHANNELS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);

    Preconditions.checkState(!siteDaos.isEmpty(), SITES_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkState(!siteChanDaos.isEmpty(), SITE_CHANS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkState(!channelGroups.isEmpty(), CHANNEL_GROUPS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
    Preconditions.checkState(!channels.isEmpty(), CHANNELS_NOT_EMPTY + START_END_TIME_STR, versionStartTime, versionEndTime);
