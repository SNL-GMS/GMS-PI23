...
public class StationDefinitionManager {
  ...
  /**
   * Retrieves all {@link StationGroup} objects specified by a list of station
   * group names and optional effective time instant and optional faceting
   * definition. If the list is empty, the server will return an empty list.
   *
   * @param request The collections of station groups names, effective time of
   * the groups and faceting definition
   *
  ...
  public List<StationGroup> findStationGroupsByName(
    ...
    Instant effectiveTime = request.getEffectiveTime().orElse(null);
  ...
  /**
   * Retrieves all {@link StationGroup} objects specified by a list of station
   * group names and time range bounding the groups. If the list is empty, the
   * server will return an empty list.
   *
   * @param request The collections of station groups names and time range of
   * the groups
   *
   * @return list of {@link StationGroup} objects
   */
   ...
   * effective time and optional faceting definition. If an empty list is
   * provided, this method will return an empty list of stations.
   *
   * @param request {@link StationsTimeFacetRequest} facet request object
   *
   * @return list of all {@link Station} objects for the given set of station
   * names that have an {@link Station#getEffectiveAt()} that is with in the
   * specified time range of the request.
   */
  ...
  /**
   * Retrieves all {@link Station} objects specified by a list of station names
   * and time range bounding the station. If the list is empty, the server will
   * return an empty list of stations.
   *
   * @param request The collections of station names and time range of the
   * stations
   *
  ...
  /**
   * Retrieves the times at which the provided {@link Station} and any of its
   * aggregate objects changed, within the provided time range.
   *
   * @param request the {@link Station} and bounding time range
   *
   * @return a collection of {@link Instant}s representing times when new
   * versions of the {@link Station} and/or any of its aggregate objects became
   * effective
   */
  ...
  /**
   * Retrieves all {@link ChannelGroup} objects specified by a list of channel
   * group names, with optional effective time and optional faceting definition.
   * If the list is empty, the server will return an empty list of channel
   * groups.
   *
   ...
   * Retrieves all {@link ChannelGroup} objects specified by a list of channel
   * group names and time range bounding the groups. If the list is empty, the
   * server will return an empty list of channel groups.
   *
   * @param request The collections of channel group names and time range of the
   * channel groups
   *
   * @return list of {@link ChannelGroup} objects
   */
   ...
   * with optional effective time and optional faceting definition. If the list
   * is empty, the server will return an empty list of channels.
   *
   * @param request The {@link ChannelsTimeFacetRequest} containing the query
   * information
   *
  ...
  public List<Channel> findChannels(
    ...
    Instant time = request.getEffectiveTime().orElse(null);
  ...
  /**
   * Retrieves all {@link Channel} objects specified by a list of channel names
   * and time range bounding the groups. If the list is empty, the server will
   * return an empty list of channels.
   *
   * @param request The collections of channel names and time range of the
   * channels
   *
   * @return list of {@link Channel} objects
   */
  ...
  /**
   * Returns a list of {@link Response} objects that corresponds to the list of
   * Response Ids passed in.
   * <p>
   * If no ids are passed into this interface, an empty list of Responses is
   * returned. if no time is provided to the optional effectiveTime, the time of
   * request is the default if no faceting definition is provided, FAP is
   * faceted by ID
   *
   * @param request a request object with optional time and optional faceting
   * definition
   *
   * @return list of all {@link Response} objects for the given set of Response
   * ids.
   */
  ...
  /**
   * Returns a list of {@link Response} objects that correspond to the list of
   * Response ids passed in that lie in the requested time range
   * <p>
   * If no ids are passed into the interface, an empty list of Responses is
   * returned.
   *
   * @param request a {@link ResponseTimeRangeRequest} object with ids and time
   * range
   *
   * @return list of all {@link Response} objects for the given ids and time
   * range
   */
