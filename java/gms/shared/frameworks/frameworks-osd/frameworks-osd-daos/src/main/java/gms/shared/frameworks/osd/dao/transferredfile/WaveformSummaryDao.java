...
public class WaveformSummaryDao {
  ...
  private Instant endTime;
	...
	@Column(name = "reception_time", nullable = false, updatable = false)
  ...
  private WaveformSummaryDao(String channelName, Instant startTime, Instant endTime, Instant receptionTime) {
  ...
  public static WaveformSummaryDao from(WaveformSummary waveformSummary, Instant receptionTime) {
    return new WaveformSummaryDao(waveformSummary.getChannelName(), waveformSummary.getStartTime(),
      waveformSummary.getEndTime(), receptionTime);
  }
