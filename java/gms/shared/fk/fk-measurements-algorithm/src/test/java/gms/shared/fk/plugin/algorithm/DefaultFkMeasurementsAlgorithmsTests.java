...
class DefaultFkMeasurementsAlgorithmsTests {
  ...
  void testAzimuthOfIndex() {
    ...
    assertEquals(225.0, DefaultFkMeasurementsAlgorithms.azimuthOfIndex(0, 0.2, 0, -0.2, 5, 5), PRECISION);
    assertEquals(233.130, DefaultFkMeasurementsAlgorithms.azimuthOfIndex(0, 0.1, 0, -0.1, 30, 40), PRECISION);
  }
