...
class MediumVelocitiesTest {
  ...
  void testMediumVelocitiesInitializeNullModelNameThrowsNullPointerException() throws IOException {
    ...
    NullPointerException ex = assertThrows(NullPointerException.class, 
      () -> m.initialize(null));
    assertEquals("modelName parameter cannot be null for MediumVelocities::initialize()", ex.getMessage());
  }
  ...
  void testMediumVelocitiesGetMediumVelocityNullPhaseTypeThrowsNullPointerException()
    ...
    NullPointerException ex = assertThrows(NullPointerException.class, () -> m.getMediumVelocity(null));
    assertEquals("PhaseType parameter cannot be null in MediumVelocities::getMediumVelocity()", ex.getMessage());
  }
