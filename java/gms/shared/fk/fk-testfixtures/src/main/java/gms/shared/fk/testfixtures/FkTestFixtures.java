...
public class FkTestFixtures {
  ...
  public static final FkSpectraDefinition DEFINITION = FkSpectraDefinition.builder()
   ...
   public static final FkStreamingRequest REQUEST = FkStreamingRequest.builder()
