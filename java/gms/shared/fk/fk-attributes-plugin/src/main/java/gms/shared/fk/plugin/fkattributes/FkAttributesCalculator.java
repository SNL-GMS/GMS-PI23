 ...
 * if a call to the azimuth method will first calculate the slowness uncertainty if it has not
...
public class FkAttributesCalculator {
  ...
  public double azimuth() {
    if (azimuth == null) {
      azimuth = DefaultFkMeasurementsAlgorithms
  ...
  public double slowness() {
    if (slowness == null) {
      slowness = DefaultFkMeasurementsAlgorithms
  ...
  public double azimuthUncertainty() {
    if (azimuthUncertainty == null) {
      azimuthUncertainty = DefaultFkMeasurementsAlgorithms
