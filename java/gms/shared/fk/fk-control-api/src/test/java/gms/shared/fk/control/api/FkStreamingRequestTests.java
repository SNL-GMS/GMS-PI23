...
class FkStreamingRequestTests {
  
  private static final FkStreamingRequest REQUEST = FkStreamingRequest.builder()
  ...
  static Stream<Arguments> getBuildArguments() {
    return Stream.of(
      arguments("Error creating FkStreamingRequest: Sample Rate must be greater than 0", 
        REQUEST.toBuilder().setSampleRate(-2.0)), 
      arguments("Error creating FkStreamingRequest: Sample Count must be greater than 0", 
        REQUEST.toBuilder().setSampleCount(0)), 
      arguments("Error creating FkStreamingRequest: Channel Names cannot be empty", 
