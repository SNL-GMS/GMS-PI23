...
class IaspeiTravelTimeLookupTableTest {

  @Mock
  static FileStore mockedFileStore;
  @Mock
  static IaspeiTravelTimeLookupTableConfiguration mockedConfiguration;
  ...
  private IaspeiTravelTimeLookupTable lookupTable;

  @BeforeAll
  static void initialize() {

    TravelTimeLookupView viewP = TravelTimeLookupView.builder()
      .setModel(EarthModelType.IASPEI)
  ...
  void setup() {
    ...
    lookupTable = new IaspeiTravelTimeLookupTable(mockedFileStore, mockedConfiguration);
  }
  ...
  void testGetName() {
    setup();
    Assertions.assertDoesNotThrow(() -> lookupTable.initialize());
    Assertions.assertEquals("IaspeiTravelTimeLookupTable", lookupTable.getName());
  }
