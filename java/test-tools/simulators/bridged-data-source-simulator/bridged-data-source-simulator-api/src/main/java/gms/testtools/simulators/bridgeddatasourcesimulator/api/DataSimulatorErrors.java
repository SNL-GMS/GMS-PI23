...
/**
 * DTO Class for /errors endpoint, informing clients of errors that have occurred in asynchronous simulator commands
 */
@AutoValue
public abstract class DataSimulatorErrors {
  ...
  @JsonCreator
  public static DataSimulatorErrors create(String command, Map<String, ExceptionSummary> exceptionSummariesBySimulator) {
