...
class DataSimulatorSpecTest {
  ...
  void successfulValidation() {
    assertDoesNotThrow(() -> DataSimulatorSpec.builder()
  ...
  void testSerializationGood() throws IOException {
    DataSimulatorSpec bridgedDataSourceSimulatorSpec = DataSimulatorSpec.builder()
      .setSeedDataStartTime(VALID_INSTANT_1600)
      .setSeedDataEndTime(VALID_INSTANT_1800)
      .setSimulationStartTime(Instant.now())
      .setOperationalTimePeriod(VALID_OP_TIME)
    ...
    TestUtilities.testSerialization(bridgedDataSourceSimulatorSpec, DataSimulatorSpec.class);
  }
}
