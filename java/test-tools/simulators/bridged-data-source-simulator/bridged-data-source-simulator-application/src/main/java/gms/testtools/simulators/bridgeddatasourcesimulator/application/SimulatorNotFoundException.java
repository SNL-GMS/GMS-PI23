...
/**
 *
 * Help exception denoting a simulator of a particular type was not found when attempting to run simulator-specific
 * commands at the service level of an application.
 */
