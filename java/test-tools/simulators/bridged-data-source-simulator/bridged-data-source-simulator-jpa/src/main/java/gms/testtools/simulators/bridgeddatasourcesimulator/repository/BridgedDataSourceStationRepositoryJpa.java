...
public class BridgedDataSourceStationRepositoryJpa extends BridgedDataSourceRepositoryJpa
  ...
  public static BridgedDataSourceStationRepositoryJpa create(EntityManagerFactory entityManagerFactory) {
  ...
  /**
   * Store the collection of SiteChanDaos in the database, update the end dates
   * of all relevant SiteChanDaos in DB.
   *
  ...
  /**
   * Store the collection of SiteDaos in the database, update the end dates of
   * all relevant SiteDaos in DB.
   *
