...
public class BridgedDataSourceIntervalRepositoryJpa extends BridgedDataSourceRepositoryJpa
  ...
  public static BridgedDataSourceIntervalRepositoryJpa create(EntityManagerFactory entityManagerFactory) {
   ...
   * ClassEndTimeNameTimeKey} exists, update it with the values from the
   * {@code simulationData}. Otherwise, insert the {@code simulationData} into
   * the database.
   *
   * @param simulationData a list of {@link IntervalDao}s to update or insert
   * into the database
   */
