...
export const stationGroupCapabilityRollupConfigName =
  'soh-control.station-group-capability-rollup';
export const stationEnvMonitorTypesConfigName =
  'soh-control.station-env-monitor-types';
